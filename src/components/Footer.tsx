        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li>
                <NavLink to="/" className="text-ips-neutral-200 hover:text-ips-blue transition-colors duration-300">
                  Home
                </NavLink>
              </li>
              <li>
                <NavLink to="/about" className="text-ips-neutral-200 hover:text-ips-blue transition-colors duration-300">
                  About Us
                </NavLink>
              </li>
              <li>
                <NavLink to="/services" className="text-ips-neutral-200 hover:text-ips-blue transition-colors duration-300">
                  Our Services
                </NavLink>
              </li>
              <li>
                <NavLink to="/contact" className="text-ips-neutral-200 hover:text-ips-blue transition-colors duration-300">
                  Contact Us
                </NavLink>
              </li>
            </ul>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href="tel:+977981885955" className="text-white hover:text-ips-blue transition-colors duration-300">
                    +977 9818 85955
                  </a>
                </div>
              </li>
              <li className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href="mailto:prajwalkc99@gmail.com" className="text-white hover:text-ips-blue transition-colors duration-300">
                    prajwalkc99@gmail.com
                  </a>
                </div>
              </li>
              <li className="flex items-start space-x-3">
                <MapPin size={20} className="text-ips-blue flex-shrink-0 mt-1" />
                <div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li className="text-ips-neutral-200">
                <span className="text-white font-medium">Mon - Fri:</span> 9:00 AM - 6:00 PM
              </li>
              <li className="text-ips-neutral-200">
                <span className="text-white font-medium">Saturday:</span> 9:00 AM - 2:00 PM
              </li>
              <li className="text-ips-neutral-200">
