  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label htmlFor="name" className="block text-sm font-medium text-ips-neutral-800 mb-1">
            Your Name
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="email" className="block text-sm font-medium text-ips-neutral-800 mb-1">
            Email Address
          </label>
          <input
            type="email"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label htmlFor="phone" className="block text-sm font-medium text-ips-neutral-800 mb-1">
            Phone Number
          </label>
          <input
            type="tel"
        ...
        <div>
          <label htmlFor="subject" className="block text-sm font-medium text-ips-neutral-800 mb-1">
            Subject
          </label>
          <select
            id="subject"
      ...
      <div>
        <label htmlFor="message" className="block text-sm font-medium text-ips-neutral-800 mb-1">
          Your Message
        </label>
        <textarea
          id="message"
