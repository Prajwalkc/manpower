      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="space-y-8">
            <div className="glass-card p-8 rounded-lg">
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-ips-neutral-900 mb-1">Phone</h3>
                    <a href="tel:+977981885955" className="text-ips-neutral-800 hover:text-ips-blue transition-colors">
                      +977 9818 85955
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-ips-neutral-900 mb-1">Email</h3>
                    <a href="mailto:prajwalkc99@gmail.com" className="text-ips-neutral-800 hover:text-ips-blue transition-colors">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-ips-neutral-900 mb-1">Location</h3>
            ...
            <div className="glass-card p-8 rounded-lg">
              <h3 className="text-xl font-medium text-ips-neutral-900 mb-4">Business Hours</h3>
          ...
          <div className="glass-card p-8 rounded-lg">
            <h3 className="text-2xl font-medium text-ips-neutral-900 mb-6">Send Us a Message</h3>
            <ContactForm />
          </div>
        </div>
