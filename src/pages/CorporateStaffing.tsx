        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1 text-center md:text-left">
            <div className="inline-flex items-center mb-4">
              <Building className="w-10 h-10 text-ips-blue mr-3" />
            ...
            <p className="text-lg text-ips-neutral-700 mb-6 max-w-xl">
              We provide tailored staffing solutions for businesses of all
              sizes, helping them build skilled teams that drive growth and
              success.
            </p>
            <Link to="/contact">
        ...
        <div className="container mx-auto max-w-3xl">
          <div className="bg-ips-blue/5 rounded-lg p-6 mb-8 shadow-card">
            ...
            <p className="text-ips-neutral-700">
              Our corporate staffing services are designed to be flexible,
              scalable, and aligned with your business goals. We deliver top
              talent for every role, from entry-level to executive.
            </p>
          </div>
      ...
      <section className="py-12 px-4 md:px-8 bg-ips-neutral-50">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg text-ips-neutral-700 mb-8 max-w-2xl mx-auto">
            Let us help you build a high-performing team. Contact us today to
            discuss your staffing needs and discover how we can support your
            business.
          </p>
          <Link to="/contact">
            <Button size="lg" className="px-8">
